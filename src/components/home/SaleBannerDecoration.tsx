...
import {
  ...
  SALE_BANNER_DECORATION_INNER_HEIGHT_PX,
  SALE_BANNER_DECORATION_INNER_HEIGHT_RATIO,
  SALE_BANNER_DECORATION_INNER_WIDTH_PX,
...
/** Figma `51:364` — cropped decoration image inside rotated frame. */
  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      <Image
        ...
        alt=""
        width={SALE_BANNER_DECORATION_INNER_WIDTH_PX}
        height={SALE_BANNER_DECORATION_INNER_HEIGHT_PX}
        sizes="(min-width: 768px) 849px, 0px"
...
/** Figma `51:364` — rotated dress decoration on sale banner. */
export function SaleBannerDecoration() {
  return (
    ...
    >
      <div className="flex-none" style={{ transform: `rotate(${SALE_BANNER_DECORATION_ROTATE_DEG}deg)` }}>
        <div
          className="relative"
          style={{
