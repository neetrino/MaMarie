      ...
      >
        ...
        <div
          ...
          style={{
            ...
            minHeight: SALE_BANNER_CTA_OFFSET_TOP_PX + SALE_BANNER_CTA_HEIGHT_PX,
          }}
        >
          <h3
            ...
            style={{
              fontSize: SALE_BANNER_TITLE_SIZE_PX,
              lineHeight: `${SALE_BANNER_TITLE_LINE_HEIGHT_PX}px`,
              marginTop: -11,
            }}
          >
          ...
          <p
            ...
            style={{
              left: 0,
              top: SALE_BANNER_SUBTITLE_OFFSET_TOP_PX,
              maxWidth: SALE_BANNER_SUBTITLE_MAX_WIDTH_PX,
              fontSize: SALE_BANNER_SUBTITLE_SIZE_PX,
              lineHeight: `${SALE_BANNER_SUBTITLE_LINE_HEIGHT_PX}px`,
            }}
          >
          ...
          <Link
            ...
            style={{
              left: 0,
              top: SALE_BANNER_CTA_OFFSET_TOP_PX,
