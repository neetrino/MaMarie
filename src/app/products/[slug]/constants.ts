...
export const PRODUCT_PDP_THUMBNAIL_LIST_MOBILE_CLASS =
  'flex w-full flex-row justify-center gap-3 overflow-x-auto overscroll-contain py-1 lg:flex-col lg:justify-start lg:gap-4 lg:max-h-[29.5rem] lg:overflow-y-auto lg:overflow-x-visible lg:py-0';
