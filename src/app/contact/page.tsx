...
import { CONTACT_FORM_CARD_BG, CONTACT_FORM_SECTION_BG } from '../../constants/contact-form';
          ...
          <div className="space-y-8">
            <div>
              <div className="mb-3 flex items-center gap-3">
                <div
                  className="flex h-12 w-12 items-center justify-center rounded-full text-gray-700"
                  style={{ backgroundColor: CONTACT_FORM_CARD_BG }}
                >
                  <PhoneIcon />
                </div>
            ...
            <div>
              ...
              <p className="font-medium text-orange-500">{t('contact.address')}</p>
            </div>
          </div>
