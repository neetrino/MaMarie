...
export const CONTACT_PAGE_MOBILE_STRAWBERRY_OVERHANG_PX = 32;
export const CONTACT_PAGE_MOBILE_PADDING_RIGHT_PX =
  CONTACT_PAGE_MOBILE_HORIZONTAL_PADDING_PX + CONTACT_PAGE_MOBILE_STRAWBERRY_OVERHANG_PX;
