...
export const CONTACT_FORM_INPUT_LINE_HEIGHT_PX = 26;
export const CONTACT_FORM_INPUT_VERTICAL_PADDING_PX =
  (CONTACT_FORM_INPUT_HEIGHT_PX - CONTACT_FORM_INPUT_LINE_HEIGHT_PX) / 2;
