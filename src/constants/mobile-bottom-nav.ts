...
/** Cart active — Figma `109:579`. */
export const MOBILE_BOTTOM_NAV_CART_CIRCLE_LEFT_PX = 92;
export const MOBILE_BOTTOM_NAV_CART_ACTIVE_SLOT_LEFT_PX = 108;

/** Wishlist active — Figma `109:600`. */
export const MOBILE_BOTTOM_NAV_WISHLIST_CIRCLE_LEFT_PX = 172;
export const MOBILE_BOTTOM_NAV_WISHLIST_ACTIVE_SLOT_LEFT_PX = 188;

/** Profile active — Figma `109:621`. */
...
export const MOBILE_BOTTOM_NAV_ITEM_INACTIVE_SLOT_LEFTS_PX = [110, 189, 268] as const;
...
export type MobileBottomNavItemId = 'home' | 'cart' | 'wishlist' | 'profile';
