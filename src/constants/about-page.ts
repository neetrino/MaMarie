...
/** Mobile — Figma `324:616` (content only; navbar from layout). */
export const ABOUT_PAGE_MOBILE_BG = '#f5f5f5';
export const ABOUT_PAGE_MOBILE_MAX_WIDTH_PX = 401;
export const ABOUT_PAGE_MOBILE_PADDING_X_PX = 20;
export const ABOUT_PAGE_MOBILE_PADDING_TOP_PX = 16;
export const ABOUT_PAGE_MOBILE_PADDING_BOTTOM_PX = 0;
export const ABOUT_PAGE_MOBILE_TITLE_WIDTH_PX = 342;
export const ABOUT_PAGE_MOBILE_TITLE_HEIGHT_PX = 112;
export const ABOUT_PAGE_MOBILE_HERO_WIDTH_PX = 440;
export const ABOUT_PAGE_MOBILE_HERO_HEIGHT_PX = 654;
export const ABOUT_PAGE_MOBILE_HERO_OFFSET_X_PX = 23.5;
export const ABOUT_PAGE_MOBILE_HERO_RADIUS_PX = 40;
export const ABOUT_PAGE_MOBILE_HERO_OVERLAP_TITLE_PX = 51;
export const ABOUT_PAGE_MOBILE_CARD_WIDTH_PX = 362;
export const ABOUT_PAGE_MOBILE_CARD_RADIUS_PX = 40;
export const ABOUT_PAGE_MOBILE_CARD_PADDING_X_PX = 30;
export const ABOUT_PAGE_MOBILE_CARD_PADDING_TOP_PX = 35;
export const ABOUT_PAGE_MOBILE_CARD_PADDING_BOTTOM_PX = 32;
/** Extra length so story card continues under the photo. */
export const ABOUT_PAGE_MOBILE_STORY_CARD_PADDING_BOTTOM_PX = 120;
export const ABOUT_PAGE_MOBILE_STORY_CARD_GAP_PX = 16;
/** Story card under hero — Figma tops 820→734. */
export const ABOUT_PAGE_MOBILE_SECTION_GAP_PX = -86;
export const ABOUT_PAGE_MOBILE_PHOTO_HEIGHT_PX = 453;
/** Pull photo up so story card sits underneath. */
export const ABOUT_PAGE_MOBILE_STORY_TO_PHOTO_GAP_PX = -88;
/** Closing card under photo — Figma tops 1510→1391. */
export const ABOUT_PAGE_MOBILE_PHOTO_TO_CLOSING_GAP_PX = -119;
export const ABOUT_PAGE_MOBILE_CLOSING_PADDING_TOP_PX = 46;
export const ABOUT_PAGE_MOBILE_CLOSING_TEXT_SIZE_PX = 16;
export const ABOUT_PAGE_MOBILE_CLOSING_LINE_HEIGHT_PX = 23;
export const ABOUT_PAGE_MOBILE_BODY_TEXT_SIZE_PX = 14;
export const ABOUT_PAGE_MOBILE_BODY_LINE_HEIGHT_PX = 20;
/** Photo crop — Figma `324:914`. */
export const ABOUT_PAGE_MOBILE_PHOTO_IMG_WIDTH_PERCENT = 100.12;
export const ABOUT_PAGE_MOBILE_PHOTO_IMG_HEIGHT_PERCENT = 120.2;
export const ABOUT_PAGE_MOBILE_PHOTO_IMG_LEFT_PERCENT = -0.06;
export const ABOUT_PAGE_MOBILE_PHOTO_IMG_TOP_PERCENT = -20.2;
export const ABOUT_PAGE_MOBILE_STRAWBERRY_WRAPPER_SIZE_PX = 175.201;
export const ABOUT_PAGE_MOBILE_STRAWBERRY_IMAGE_SIZE_PX = 128.059;
export const ABOUT_PAGE_MOBILE_STRAWBERRY_ROTATE_DEG = 59.67;
/** Relative to photo — Figma left 243 − 20. */
export const ABOUT_PAGE_MOBILE_STRAWBERRY_LEFT_PX = 223;
export const ABOUT_PAGE_MOBILE_STRAWBERRY_TOP_PX = -60;
export const ABOUT_PAGE_MOBILE_LEAD_LOGO_WIDTH_PX = 86;
export const ABOUT_PAGE_MOBILE_LEAD_LOGO_HEIGHT_PX = 37;
/** Logo crop — Figma `324:911`. */
export const ABOUT_PAGE_MOBILE_LEAD_LOGO_CROP_HEIGHT_PERCENT = 237.18;
export const ABOUT_PAGE_MOBILE_LEAD_LOGO_CROP_WIDTH_PERCENT = 100;
export const ABOUT_PAGE_MOBILE_LEAD_LOGO_CROP_LEFT_PERCENT = 0;
export const ABOUT_PAGE_MOBILE_LEAD_LOGO_CROP_TOP_PERCENT = -67.18;
export const ABOUT_PAGE_MOBILE_LEAD_TEXT_OFFSET_TOP_PX = 8;
export const ABOUT_PAGE_MOBILE_LEAD_GAP_PX = 4;
